...
const axureDistDir = path.resolve(workspaceRoot, 'axure-dist');
const distDir = path.resolve(workspaceRoot, 'dist');
for (const dir of [axureDistDir, distDir]) {
...
fs.cpSync(axureDistDir, distDir, { recursive: true });
console.log(`\n已将 axure-dist 复制到 dist ✅`);
console.log('\n所有入口构建完成 ✅');

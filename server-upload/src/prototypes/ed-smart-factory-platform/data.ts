...
export const deviceList = [
  { key: '1', code: 'ERR0001', name: '下壳体与定子装配设备', oee: 90, runTime: '19时03分', faultTime: '19时03分', idleTime: '19时03分', offTime: '19时03分', runPct: 60, faultPct: 20, idlePct: 10, offPct: 10 },
  { key: '2', code: 'ERR0002', name: '三相端子装配设备', oee: 60, runTime: '19时03分', faultTime: '19时03分', idleTime: '19时03分', offTime: '19时03分', runPct: 60, faultPct: 20, idlePct: 10, offPct: 10 },
  { key: '3', code: 'ERR0003', name: '三相端子螺栓拧紧设备', oee: 80, runTime: '19时03分', faultTime: '19时03分', idleTime: '19时03分', offTime: '19时03分', runPct: 60, faultPct: 20, idlePct: 10, offPct: 10 },
  { key: '4', code: 'ERR0004', name: '电机绝缘耐压测试设备', oee: 70, runTime: '19时03分', faultTime: '19时03分', idleTime: '19时03分', offTime: '19时03分', runPct: 60, faultPct: 20, idlePct: 10, offPct: 10 },
];
...
export const oeeColumns = [{ title: '日期', dataIndex: 'date' }, { title: '设备', dataIndex: 'equip' }, { title: '时间稼动率', dataIndex: 'availability', render: (v: number) => `${v}%` }, { title: '性能稼动率', dataIndex: 'performance', render: (v: number) => `${v}%` }, { title: '良品率', dataIndex: 'quality', render: (v: number) => `${v}%` }, { title: 'OEE', dataIndex: 'oee', render: (v: number) => `${v}%` }];
export const oeeData = [
  { key: '1', date: '2026-06-13', equip: '装配设备#01', availability: 88, performance: 92, quality: 98, oee: 79.4 },
  { key: '2', date: '2026-06-13', equip: '测试设备#02', availability: 92, performance: 95, quality: 99, oee: 86.5 },
  { key: '3', date: '2026-06-14', equip: '装配设备#01', availability: 90, performance: 93, quality: 97, oee: 81.2 },
  { key: '4', date: '2026-06-14', equip: '测试设备#02', availability: 85, performance: 90, quality: 98, oee: 74.9 },
  { key: '5', date: '2026-06-15', equip: '装配设备#01', availability: 93, performance: 94, quality: 99, oee: 86.6 },
];
